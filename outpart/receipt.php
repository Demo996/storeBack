...
// 插入到总库
$sql1 = "INSERT INTO receipt VALUES('$getArr[0]','$getArr[1]','$getArr[2]','$getArr[3]','$getArr[4]','$getArr[5]','$getArr[6]',$getArr[7],'$getArr[8]',
        '$getArr[9]','$getArr[10]','$getArr[11]','$operator')";
...
// 插入到所属库
$sql2 = "INSERT INTO $store.receipt VALUES('$getArr[0]','$getArr[1]','$getArr[2]','$getArr[3]','$getArr[4]','$getArr[5]','$getArr[6]',$getArr[7],'$getArr[8]',
        '$getArr[9]','$getArr[10]','$getArr[11]','$operator')";
...
// 领用物品时  正在领用的库表数量也在变化
$sql3 = "INSERT INTO externalstorege.now_return VALUES('$getArr[0]','$getArr[1]','$getArr[2]','$getArr[3]','$getArr[4]','$getArr[5]','$getArr[6]',$getArr[7],'$getArr[8]') ON DUPLICATE KEY UPDATE 数量=数量+$getArr[7]";
